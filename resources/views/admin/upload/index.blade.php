...
<head>
    ...
    <title>文件管理</title>
    <link rel="stylesheet" type="text/css" href="{{ asset('admin/assets/plugins/webuploader/webuploader.css') }}">
    <link rel="stylesheet" type="text/css" href="{{ asset('admin/assets/plugins/webuploader/css/style.css') }}">
</head>
<body>
...
<script type="text/javascript" src="{{ asset('admin/assets/plugins/jquery/jquery-1.9.1.min.js') }}"></script>
<script type="text/javascript" src="{{ asset('admin/assets/plugins/webuploader/webuploader.min.js') }}"></script>
<script type="text/javascript" src="{{ asset('admin/assets/plugins/webuploader/upload.js') }}"></script>
<script>
    $(function(){
        moudle = 'Admin';
        var config = {
            "swf":"{{ asset('admin/assets/plugins/webuploader/Uploader.swf') }}",
            "server":"{{ $info['upload'] }}",
            //"filelistPah":"{$info.fileList}",
            "delPath":"{{ route('upload.delupload') }}",
            "chunked":false,
            "chunkSize":1024000,
