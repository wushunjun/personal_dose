...
@section('style')
            ...
            <div class="panel panel-default" data-sortable-id="table-basic-2">
                ...
                <div class="panel-body">
                    <div class="row">
                        ...
                        <div class="col-md-12 col-sm-12">
                            <form action="{{ route('plan.index') }}" class="form-inline pull-right">
                                ...
                                <div class="input-group input-group-sm" style="width: 250px;">
                                    ...
                                    <input type="text" name="_kw" class="form-control pull-right"
                                           placeholder="请填写计划名称" value="{{ $params['_kw'] ?? '' }}">
                        ...
                        @if(count($lists))
                            @foreach($lists as $item)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('plan.edit', ['id'=>$item->id]) }}" data-toggle="modal"
                                           data-target="#modal-default-edit"
                                           class="btn btn-success btn-xs"><i class="fa fa-edit"></i> 编辑</a>
                                        @if(!$item->recovery_count)
                                            <a href="javascript:void(0);"
                                               data-href="{{ route('plan.destroy', ['id'=>$item->id]) }}"
    ...
    <div class="modal fade" id="modal-dialog">
        <div class="modal-dialog">
            <form class="form-horizontal" data-parsley-validate="true" name="demo-form"
                  action="{{ route('plan.store') }}" method="post" id="create">
                {{ csrf_field() }}
    ...
    <div class="modal fade" id="modal-default-edit">
        <div class="modal-dialog">
            <form class="form-horizontal" action="{{ route('plan.update') }}" id="edit" method="post"
