...
@section('title', '样品审核统计')
@section('breadcrumb')
    {!! Breadcrumbs::render('check_report'); !!}
@endsection
@section('style')
            ...
            <div class="panel panel-default" data-sortable-id="table-basic-2">
                ...
                <div class="panel-body">
                    <div class="row">
                        ...
                        <div class="col-md-12 col-sm-12">
                            {{--<form action="{{ route('check_report.index') }}" class="form-inline pull-right">
                        ...
                        @if(count($count))
                            @foreach($count as $item)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('check_report.company_list', ['plan_id'=>$item['plan_id']]) }}"
